...
mol_idx_to_keep = [38, 53, 60, 159, 160,163, 164, 45, 143, 147, 144, 148, 30, 180, 176, 127, 131, 22, 26, 132, 128, 68, 72, 76, 175, 179, 155, 156, 140, 139, 172, 123, 124,  171]


# pentacene_idx = np.array([mol_idx[232]])
# print(f'Pentacene indices: {pentacene_idx}')

#print mol indx and corresponding atomic indexes
# for i in mol_idx_to_keep:
#     print(f'Molecule {i}: {mol_idx[i]}')
...
scaling_factor_nn_atoms = 1*frequency_factor
...
with open(f"Host_mode_9.xyz", "w") as f:
    f.write(f"{nn_total_atoms}\n")
